  ...
  Future<void> _fetchRecipes() async {
    ...
    try {
      ...
      if (_maxCookingTime != null) {
        query = query.lte('time_baking', _maxCookingTime as Object);
      }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(
                _showOnlyMine ? Icons.person : Icons.people_alt_outlined),
            tooltip: _showOnlyMine ? loc.allRecipes : loc.showMyRecipes,
            onPressed: _toggleFilter,
          ),

          // ⏱️ Cooking time filter button
          PopupMenuButton<int?>(
            icon: const Icon(Icons.timer_outlined),
            tooltip: loc.filterTime,
            onSelected: (value) {
            ...
            itemBuilder: (context) => const [
              ...
              PopupMenuItem(value: 120, child: Text("≤ 2 hours")),
            ],
          ),
        ],
      ),
        ...
        children: [
          if (_maxCookingTime != null)
            Padding(
              ...
              child: Text("${loc.showingCooking} $_maxCookingTime min",
                    ...
                    subtitle: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (recipe['time_baking'] !=
                              null)
                            Text(
                              '${loc.cookingTime}: ${recipe['time_baking']} min',
                              style: const TextStyle(
                                  fontSize: 13,
                                  color: Colors.black54),
                            ),
